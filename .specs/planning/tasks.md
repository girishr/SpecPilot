...
1. [CS-075] Fix stale `Cowork` reference in `.specs/development/docs.md:102` — replace `CLAUDE.md` for Cowork` with `CLAUDE.md` for Claude Code`; single-line text change, no code or test impact
